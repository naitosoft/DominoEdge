...
(function() {
    ...
    Game_Picture.prototype.addSheetCellIndex = function() {
        if ( ($gameVariables.value(258)) > 0) {
        this.setSheetCellIndex(this.getSheetCellIndex() * 0 + ($gameVariables.value(250)));
    }
        if ( ($gameVariables.value(258)) == 0) {
        this.setSheetCellIndex(this.getSheetCellIndex() + ($gameVariables.value(250)));
    }
    };
